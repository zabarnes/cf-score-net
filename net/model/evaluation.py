...
def evaluate_sess_out(sess, model_spec, num_steps, writer=None, params=None):

    l = model_spec['labels']
    p = model_spec['probabilities']
...
def evaluate(model_spec, model_dir, params, restore_from):
    ...
    with tf.Session() as sess:
        ...
        return evaluate_sess_out(sess, model_spec, num_steps)
